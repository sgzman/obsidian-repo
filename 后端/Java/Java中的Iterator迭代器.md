**以下内容来自廖雪峰学Java**
[使用Iterator - 廖雪峰的官方网站 (liaoxuefeng.com)](https://www.liaoxuefeng.com/wiki/1252599548343744/1265124784468736)
...
使用迭代器的<font color="#ff0000">好处</font>在于，调用方总是以统一的方式遍历各种集合类型，而不必关心它们内部的存储结构。
